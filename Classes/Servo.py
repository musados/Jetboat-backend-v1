...
SERVO_MIN_DUTY = 0.5/1000#2.5+OFFSE_DUTY #define pulse duty cycle for minimum angle of servo
SERVO_MAX_DUTY = 2.5/1000#12.5+OFFSE_DUTY #define pulse duty cycle for maximum angle of servo
servoPin = 12
...
def loop():
    while True:
        for dc in range(0, 181, 10): # make servo rotate from 0 to 180 deg
